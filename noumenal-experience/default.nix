...
in
{
  ...
  systemd.services.caddy.environment."CADDY_ADMIN" = "100.108.104.117:2019";
  services.caddy = {
    enable = true;
    ...
    virtualHosts."normal.style.computer".extraConfig = proxyBaum 7530 false;
    ...
    virtualHosts."opodsync.tali.network".extraConfig = proxyBaum 2026 false;
  ...
  networking.hostName = "noumenal-experience";
  networking.domain = "";
